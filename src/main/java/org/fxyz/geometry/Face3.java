...
public class Face3 {
    ...
    public IntStream getFace(int t) { return IntStreams.of(p0,t,p1,t,p2,t); }
    public IntStream getFace(int t0, int t1, int t2) { return IntStreams.of(p0,t0,p1,t1,p2,t2); }
    public IntStream getFace(Face3 t) { return IntStreams.of(p0,t.p0,p1,t.p1,p2,t.p2); }
