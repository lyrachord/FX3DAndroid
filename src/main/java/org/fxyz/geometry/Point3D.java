...
public class Point3D {
    ...
    */
    ...
    public DoubleStream getCoordinates() { return DoubleStreams.of(x,y,z); }
    public DoubleStream getCoordinates(float factor) { return DoubleStreams.of(factor*x,factor*y,factor*z); }
